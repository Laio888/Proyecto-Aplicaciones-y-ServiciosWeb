// RepositorioLecturaSqlServer.cs — Implementación mejorada para SQL Server con detección de tipos
...
using ApiKnowledgeMap.Servicios.Utilidades;

namespace ApiKnowledgeMap.Repositorios
{
    /// <summary>
    /// Implementación mejorada para SQL Server con detección automática de tipos.
    /// Tablas del proyecto: car_innovacion, enfoque, practica_estrategia, aspecto_normativo, universidad
    /// </summary>
